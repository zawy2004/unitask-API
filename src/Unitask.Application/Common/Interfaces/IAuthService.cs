...
public interface IAuthService
{
    ...
    /// <summary>Gửi lại mã OTP xác thực email. Trả về mã (chỉ khác null khi Sandbox:ExposeOtp bật) để demo.</summary>
    Task<string?> ResendOtpAsync(string email, CancellationToken cancellationToken = default);
}
